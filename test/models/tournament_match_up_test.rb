...
class TournamentMatchUpTest < ActiveSupport::TestCase
  ...
  #
  #   new_tournament_match_up.bottom_tournament_team = tournament_teams(:duke_blue_devils_tournament_team)
  ...
  test "should not create tournament_match_up without unique name" do
    tournament_match_up = tournament_match_ups(:baylor_bears_south_carolina_gamecocks_tournament_match_up)

    tournament_match_up.bottom_team_score = nil
  ...
  test "should create tournament_match_up" do
    new_tournament_match_up = TournamentMatchUp.new(top_tournament_team: tournament_teams(:baylor_bears_tournament_team), bottom_tournament_team: tournament_teams(:duke_blue_devils_tournament_team))
